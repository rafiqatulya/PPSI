...
?> 
 ...
 <div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Update Pengguna</h6>
  </div>
  <div class="card-body">
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="user_name" name="user_name" placeholder=
                            "Nama" type="text" value="<?php echo $singleuser->NAME; ?>">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="user_type" id="user_type">
                          ...
                          <option <?php echo ($singleuser->TYPE=='Librarian')? 'SELECTED':'';?>>Pustakawan</option>  
                        </select> 
                      </div>
                    </div>
                  </div>
