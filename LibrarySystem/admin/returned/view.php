...
<div class="row">
            ...
            <div class="col-md-6">
             ...
             <div class="col-md-6">
                  <div class="row">
                    <div class="col-md-3"> 
                    <label class="small mb-1" for="DateBorrowed">Tanggal Peminjaman</label>  
                    </div> 
                    <div class="col-md-9"> 
                        <p><?php echo  isset($trans->DateBorrowed) ?$trans->DateBorrowed : 'None'; ?></p> 
                    </div> 
                    <div class="col-md-3"> 
                      <label class="small mb-1" for="DueDate">Deadline</label>  
                    </div> 
                    <div class="col-md-9"> 
             ...
             <div class="col-md-6">
               <div class="row"> 
                    <div class="col-md-3"> 
                      <label class="small mb-1" for="DateReturned">Tanggal Pengembalian</label>  
                    </div> 
                    <div class="col-md-9"> 
                        <p><?php echo  isset($trans->DateReturned) ?$trans->DateReturned : 'None'; ?></p> 
                    </div>    
                    <div class="col-md-3"> 
                      <label class="small mb-1" for="Remarks">Keterangan</label>  
                    </div> 
                    <div class="col-md-9"> 
