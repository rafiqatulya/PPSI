...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Buku Dipinjam </h6>
...
<div class="row">
            <div class="col-md-6">  
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3"> 
                          <label class="small mb-1" for="BookTitle">Judul Buku</label>  
                     </div> 
                    <div class="col-md-9"> 
            ...
            <div class="col-md-6">
              ...
              <div class="book-details">Informasi Peminjam</div> 
                <div class="form-row">
                    ...
                    <div class="col-md-3"> 
                          <label class="small mb-1" for="MiddleName">Nama Tengah</label></label>  
                     </div> 
                    <div class="col-md-9"> 
...
<hr/>
            <div class="col-md-12">
                  <div class="row">
                    <div class="col-md-2"> 
                    <label class="small mb-1" for="DateBorrowed">Tanggal Pinjam</label>  
                    </div> 
                    <div class="col-md-9"> 
                        <p><?php echo  isset($trans->DateBorrowed) ?$trans->DateBorrowed : 'None'; ?></p> 
                    </div> 
                    <div class="col-md-2"> 
                      <label class="small mb-1" for="DueDate">Deadline Pengembalian Buku</label>  
                    </div> 
                    <div class="col-md-9"> 
...
<hr/>
        ...
        <a href="index.php" class="btn btn-success btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>  
  </div>
</div> 