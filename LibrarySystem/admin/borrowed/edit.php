...
?>
  ...
  <div class="card-body">
    ...
    <div class="form-row">
        <div class="col-md-6">
            <div class="form-group"><label class="small mb-1" for="AccessionNo">Nomor Aksesi</label><input class="form-control " id="Access" name="AccessionNo" type="text" placeholder="Masukkan Nomor Aksesi" readonly="off" value="<?php echo $object->AccessionNo;?>" /></div>
        </div> 
    </div>
    <div class="form-row">
        <div class="col-md-6">
    ...
    <div class="form-row">
        ...
        <div class="col-md-6">
            <div class="form-group"><label class="small mb-1" for="PublishDate">Tanggal Terbit</label><input class="form-control " id="datepicker" name="PublishDate" type="text" placeholder="Piluh Tanggal Terbit" value="<?php echo $object->PublishDate;?>" readonly /></div>
        </div>
    </div>  
    <div class="form-row">
        <div class="col-md-6">
