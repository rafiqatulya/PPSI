                                            ...
                                            <div class="row">
                                               <label class="col-md-2 control-label" for=
                                                ...
                                                <div class="col-md-10">
                                                  ...
                                                  "text" placeholder="Pilih Tanggal Terbit"   data-inputmask="'alias': 'date'">
                                                </div>
                                        ...
                                        <div class="form-group" id="subjcode">
                                            <div class="row">
                                               <div class="col-md-2"></div>
                                                ...
                                                <div class="col-md-10"> 
                                                   <button type="submit" name="search" class="btn btn-primary btn-lg" style="width: 100%"><i class="fa fa-search"></i> Cari</button>  
                                                </div>
 ...
 <?php }else{ ?>
     ...
     <section id="service-section">
            <div class="container">
                <div class="row">
  <div class="searchagain">Hasil Pencarian ....</div>
...
$publisheddate = $_POST['PublishDate'];
              ...
              //        echo '<tr>';  
                ...
                echo '<div class="layer">
                 ...
                 echo '<div class="layer">
                        <a href="">
                            <div class="title"  >Buku Tidak Ditemukan!</div> 
