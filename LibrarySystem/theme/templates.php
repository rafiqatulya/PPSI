...
<html lang="en">
    ...
    <head>
        ...
        <!-- Basic -->
        <title>E-Library FTI | Home</title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ul class="contact-details">
                                        <li><a href="#"><i class="fa fa-phone"></i> 0751 1234 </a>
                                        </li>
                                        <li><a href="#"><i class="fa fa-envelope-o"></i> ruangbaca@fti.com </a>
                                        </li> 
                                    </ul>
                                    <!-- End Contact Info -->
                                </div><!-- .col-md-6 -->
            ...
            <div class="navbar navbar-default navbar-top">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo web_root;?>">E-Library FTI</a>
                    </div>
                    <div class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li >
                                <a class="<?php echo ($q=='books' || $q=='borrow' || $q=='bookdetails')? 'active' : ''?>" href="<?php echo web_root;?>index.php?q=books">Buku</a>
                            </li>
                            <li>
                                <a  class="<?php echo ($q=='find')? 'active' : ''?>" href="<?php echo web_root;?>index.php?q=find">Cari Buku</a>
                            </li> 
                            <li>
                                <a  class="<?php echo ($q=='about')? 'active' : ''?>" href="<?php echo web_root;?>index.php?q=about">Tentang Kami</a>
                            </li>
                            <li >
                            	<a class="<?php echo ($q=='contact')? 'active' : ''?>" href="<?php echo web_root;?>index.php?q=contact">Kontak</a>
                            </li>
                        </ul>
                        <!-- End Navigation List -->
                    </div>
...
<!--untuk footer di main/users page red -->
                    ...
                    <div class="col-md-4">
                        <div class="section-heading-2">
                            <h3 class="section-title">
                                <span>Alamat dan Kontak</span>
                            </h3>
                        </div>
                        
                        <div class="footer-address">
                            <ul>
                                <li class="footer-contact"><i class="fa fa-home"></i>Kampus Unand, Kecamatan Pauh, Padang</li>
                                <li class="footer-contact"><i class="fa fa-envelope"></i><a href="#">ruangbaca@fti.com</a></li>
                                <li class="footer-contact"><i class="fa fa-phone"></i>0751 1234</li>
                                <li class="footer-contact"><i class="fa fa-globe"></i><a href="#" target="_blank">www.ruangbacafti.com</a></li>
                            </ul>
                        </div>
                    </div><!--/.col-md-3 -->
                    <div class="col-md-4">
                        ...
                        <div class="footer-address">
                            <ul>
                                ...
                                <li class="footer-contact"><i class="fa fa-book"></i> <a href="<?php echo web_root;?>index.php?q=books">Buku</a></li>
                                <li class="footer-contact"><i class="fa fa-search"></i> <a href="<?php echo web_root;?>index.php?q=find" target="_blank">Cari Buku</a></li>
                                <li class="footer-contact"><i class="fa fa-question"></i> <a href="#" target="<?php echo web_root;?>index.php?q=about">Tentang Kami</a></li>
                            </ul>
                        </div>
                    </div><!--/.col-md-3 -->
                    <div class="col-md-4">
                        <div class="section-heading-2">
                            <h3 class="section-title">
                                <!--title di bagian footer main page -->
        ...
        <div id="copyright-section" class="copyright-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <div class="copyright">
                            Copyright © E-Library FTI 2023. All Rights Reserved
                        </div>
                    </div>
